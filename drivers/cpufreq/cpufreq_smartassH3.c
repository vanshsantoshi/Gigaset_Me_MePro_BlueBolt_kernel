...
#include "../include/asm-generic/cputime.h"
...
static void cpufreq_smartass_timer(unsigned long cpu)
{
	...
	delta_idle = (unsigned int) cputime64_sub(now_idle, this_smartass->time_in_idle);
	delta_time = (unsigned int) cputime64_sub(update_time, this_smartass->idle_exit_time);
